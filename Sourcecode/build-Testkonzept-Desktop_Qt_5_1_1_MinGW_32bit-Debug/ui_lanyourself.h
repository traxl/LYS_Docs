...
public:
    ...
    void setupUi(QMainWindow *LanYourself)
    {
        ...
        ProNew->setGeometry(QRect(60, 70, 121, 41));
    ...
    void retranslateUi(QMainWindow *LanYourself)
    {
        ...
        ProPath->setText(QApplication::translate("LanYourself", "C:\\", 0));
        ProNew->setText(QApplication::translate("LanYourself", "Neues Profil", 0));
